...
namespace Mentosmenno2\ImageCropPositioner\Admin\Settings\HotspotsSelection;

use Mentosmenno2\ImageCropPositioner\Admin\Settings\Menu;

class Section {

	public const NAME = 'image_crop_positioner_options_hotspots_selection';
	...
	public function get_label(): string {
		return __( 'Hotspots selection', 'image-crop-positioner' );
	}
	...
	public function render_description( array $args ): void {
		$text = esc_html__( 'Here you can change the hotspots selection settings.', 'image-crop-positioner' );
		if ( empty( $text ) ) {
			return;
		}
